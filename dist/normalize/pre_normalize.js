...
define(["require", "exports", "khepri-ast/node", "khepri-ast/expression", "khepri-ast/pattern", "khepri-ast/package",
    "khepri-ast/value", "../pseudo/expression", "../pseudo/pattern", "../ast", "../fun", "../rewriter"
    ...
    rewrites.add("ArrayPattern", DOWN, (function(_) {
        ...
        var loc = __o5["loc"],
            ...
            __o6 = ((indx < 0) ? [elements0, null, []] : [elements0.slice(0, indx), elements0[indx],
    ...
    rewrites.add("ObjectPattern", UP, ((y0 = getUd.bind(null, "id")), (function(z) {
        var x = y0(z);
        return (!x);
    })), ((__o5 = markReserved(ast_pattern.IdentifierPattern.create(null, ast_value.Identifier.create(null,
        "__o")))), (function(node) {
