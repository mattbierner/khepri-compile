...
define(["require", "exports", "akh/base", "akh/trans/statei", "akh/error", "akh/trans/error", "akh/unique",
    ...
    var check, next = __o["next"],
        ...
        x, y, x0, y0, x1, y1, x2, y2, visit, createOp, __args, actions, __args1, actions0, __args0, actions1,
            checkWith, __args2, actions2, checkBlock, __args3, actions3, __args5, actions5, __args6, actions6,
            __args8, actions7, __args7, actions8, __args10, actions10, __args11, actions11, __args12, actions12,
            __args13, actions13, __args14, actions14, __args15, actions15, __args16, actions16, __args17,
            actions17, __args18, actions18, __args20, actions20, __args21, actions21, body2, __args22,
            actions22, body3, __args23, actions23, __args25, actions24, __args24, actions25, __args26,
            actions26, __args27, actions27, __args28, actions28, __args29, actions29, __args31, actions31,
            __args32, actions32, body6, __args33, actions33, body7, __args34, actions34, __args36, actions35,
        ...
        body = [((__args3 = ["body", checkTop]), (actions3 = [__args3[1]]), seq(moveChild("body"), seqa(
            actions3), up))],
    ...
    var x6 = addCheck.bind(null, "Package"),
        body0 = [((__args6 = ["exports", checkTop]), (actions6 = [__args6[1]]), seq(moveChild("exports"), seqa(
            actions6), up)), ((__args7 = ["body", checkBlockSameScope(((__args8 = ["body", checkTop]), (
            actions7 = [__args8[1]]), seq(moveChild("body"), seqa(actions7), up)))]), (actions8 = [
            __args7[1]
        ]), seq(moveChild("body"), seqa(actions8), up))],
    ...
    var x9 = addCheck.bind(null, "VariableDeclarator"),
        ...
        consequent = seq(inspect(bind), ((__args10 = ["id", checkTop]), (actions10 = [__args10[1]]), seq(
            moveChild("id"), seqa(actions10), up)), ((__args11 = ["init", checkTop]), (actions11 = [
            __args11[1]
        ]), seq(moveChild("init"), seqa(actions11), up))),
        alternate = seq(((__args12 = ["init", checkTop]), (actions12 = [__args12[1]]), seq(moveChild("init"),
            seqa(actions12), up)), inspect(bind), ((__args13 = ["id", checkTop]), (actions13 = [__args13[1]]),
            seq(moveChild("id"), seqa(actions13), up))),
        y9 = inspect((function(node) {
            return (node.recursive ? consequent : (alternate || pass));
        }));
    x9(y9);
    var x10 = addCheck.bind(null, "Binding"),
        consequent0 = seq(((__args14 = ["pattern", checkTop]), (actions14 = [__args14[1]]), seq(moveChild(
            "pattern"), seqa(actions14), up)), ((__args15 = ["value", checkTop]), (actions15 = [__args15[1]]),
            seq(moveChild("value"), seqa(actions15), up))),
        alternate0 = seq(((__args16 = ["value", checkTop]), (actions16 = [__args16[1]]), seq(moveChild("value"),
            seqa(actions16), up)), ((__args17 = ["pattern", checkTop]), (actions17 = [__args17[1]]), seq(
            moveChild("pattern"), seqa(actions17), up))),
        y10 = inspect((function(node) {
            return (node.recursive ? consequent0 : (alternate0 || pass));
        }));
    x10(y10);
    var x11 = addCheck.bind(null, "BlockStatement"),
        body1 = [((__args18 = ["body", checkTop]), (actions18 = [__args18[1]]), seq(moveChild("body"), seqa(
            actions18), up))],
    ...
    var x13 = addCheck.bind(null, "IfStatement"),
        y13 = seq(((__args20 = ["test", checkTop]), (actions20 = [__args20[1]]), seq(moveChild("test"), seqa(
            actions20), up)), ((body2 = [((__args21 = ["consequent", checkTop]), (actions21 = [__args21[1]]),
    ...
    var x14 = addCheck.bind(null, "WithStatement"),
        body4 = [((__args23 = ["bindings", checkTop]), (actions23 = [__args23[1]]), seq(moveChild("bindings"),
            seqa(actions23), up)), ((__args24 = ["body", ((__args25 = ["body", checkTop]), (actions24 = [
            __args25[1]
        ]), seq(moveChild("body"), seqa(actions24), up))]), (actions25 = [__args24[1]]), seq(moveChild(
            "body"), seqa(actions25), up))],
        y14 = seq(push, seqa(body4), pop);
    x14(y14);
    var x15 = addCheck.bind(null, "SwitchStatement"),
        body5 = [((__args26 = ["discriminant", checkTop]), (actions26 = [__args26[1]]), seq(moveChild(
            "discriminant"), seqa(actions26), up)), ((__args27 = ["cases", checkTop]), (actions27 = [
            __args27[1]
        ]), seq(moveChild("cases"), seqa(actions27), up))],
        y15 = seq(push, seqa(body5), pop);
    x15(y15);
    var x16 = addCheck.bind(null, "SwitchCase"),
        y16 = seq(((__args28 = ["test", checkTop]), (actions28 = [__args28[1]]), seq(moveChild("test"), seqa(
            actions28), up)), ((__args29 = ["consequent", checkTop]), (actions29 = [__args29[1]]), seq(
            moveChild("consequent"), seqa(actions29), up)));
    x16(y16);
    ...
    var x18 = addCheck.bind(null, "TryStatement"),
        y18 = seq(((__args31 = ["block", checkTop]), (actions31 = [__args31[1]]), seq(moveChild("block"), seqa(
            actions31), up)), ((body6 = [((__args32 = ["handler", checkTop]), (actions32 = [__args32[1]]),
    ...
    var x19 = addCheck.bind(null, "CatchClause"),
        body8 = [inspect((function(__o3) {
            ...
            actions34), up)), ((__args35 = ["body", ((__args36 = ["body", checkTop]), (actions35 = [
            __args36[1]
        ]), seq(moveChild("body"), seqa(actions35), up))]), (actions36 = [__args35[1]]), seq(moveChild(
            "body"), seqa(actions36), up))],
        y19 = seq(push, seqa(body8), pop);
    x19(y19);
    var x20 = addCheck.bind(null, "WhileStatement"),
        y20 = seq(((__args37 = ["test", checkTop]), (actions37 = [__args37[1]]), seq(moveChild("test"), seqa(
            actions37), up)), ((body9 = [((__args38 = ["body", checkTop]), (actions38 = [__args38[1]]), seq(
            moveChild("body"), seqa(actions38), up))]), seq(push, seqa(body9), pop)));
    x20(y20);
    var x21 = addCheck.bind(null, "DoWhileStatement"),
        y21 = seq(((body10 = [((__args39 = ["body", checkTop]), (actions39 = [__args39[1]]), seq(moveChild(
            "body"), seqa(actions39), up))]), seq(push, seqa(body10), pop)), ((__args40 = ["test", checkTop]), (
            actions40 = [__args40[1]]), seq(moveChild("test"), seqa(actions40), up)));
    x21(y21);
    var x22 = addCheck.bind(null, "ForStatement"),
        body11 = [((__args41 = ["init", checkTop]), (actions41 = [__args41[1]]), seq(moveChild("init"), seqa(
            actions41), up)), ((__args42 = ["test", checkTop]), (actions42 = [__args42[1]]), seq(moveChild(
            "test"), seqa(actions42), up)), ((__args43 = ["update", checkTop]), (actions43 = [__args43[1]]),
    ...
    var x24 = addCheck.bind(null, "UnaryExpression"),
        y24 = seq(((__args45 = ["argument", checkTop]), (actions45 = [__args45[1]]), seq(moveChild("argument"),
            seqa(actions45), up)), inspect((function(__o3) {
            var loc = __o3["loc"],
                ...
                .chain((function(ops) {
                    ...
                    return ((ops.length > 1) ? seq(((y25 = ops.reduceRight((function(p, c) {
                        return ast_expression.UnaryExpression.create(
                            loc, c, p);
                    }), argument)), setNode(y25)), checkTop) : ((__args46 = ["operator",
                        checkTop
                    ]), (actions46 = [__args46[1]]), seq(moveChild("operator"),
                        seqa(actions46), up)));
                }));
        })));
    x24(y24);
    var x25 = addCheck.bind(null, "AssignmentExpression"),
        y25 = seq(((__args46 = ["left", checkTop]), (actions46 = [__args46[1]]), seq(moveChild("left"), seqa(
            actions46), up)), ((consequent1 = inspect((function(__o3) {
