...
*/define(["require", "exports", "akh/base", "akh/trans/statei", "akh/error", "akh/trans/error", "akh/unique",
    "zipper-m/trans/tree", "../ast", "../fun", "./scope", "./scopet"
], (function(require, exports, __o, StateT, Error, ErrorT, Unique, TreeZipperT, __o0, __o1, scope, ScopeT) {
    "use strict";
    var check, next = __o["next"],
        ...
        checkHasBinding = (function(id, loc) {
            return examineScope((function(s) {
                return (s.hasBinding(id) ? pass : error(((("Undeclared symbol:'" + id) + "' at:") +
                    (loc && loc.start))));
            }));
        }),
    ...
    addCheck("UnaryExpression", seq(((__args45 = ["operator", checkTop]), (actions45 = [].slice.call(__args45,
        1)), seq(moveChild("operator"), seqa(actions45), up)), ((__args46 = ["argument", checkTop]), (
        actions46 = [].slice.call(__args46, 1)), seq(moveChild("argument"), seqa(actions46), up))));
    addCheck("AssignmentExpression", seq(((__args47 = ["left", checkTop]), (actions47 = [].slice.call(__args47,
        1)), seq(moveChild("left"), seqa(actions47), up)), inspect((function(__o2) {
    ...
    addCheck(["UnaryOperator"], inspect((function(node) {
        var loc = node["loc"],
            name = node["name"];
        return seq(((name[0] === ".") ? pass : checkHasBinding(name, loc)), examineScope((function(
            s) {
            return setNode(setUid(s.getUid(name), node));
        })));
    })));
