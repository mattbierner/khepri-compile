...
*/define(["require", "exports", "akh/base", "akh/trans/statei", "akh/error", "akh/trans/error", "akh/unique",
    "khepri-ast/expression", "khepri-ast/value", "zipper-m/trans/tree", "../ast", "../fun", "./scope", "./scopet"
    ...
    var check, next = __o["next"],
        ...
        splitOp = (function(op, ops) {
            ...
            return ((!op) ? [] : ((r = ops.reduce((function(p, c) {
                var prefix;
                return ((((prefix = c[0]), (op.substring(0, prefix.length) === prefix)) &&
                    ((!p) || (c[0].length > p[0].length))) ? c : p);
    ...
    addCheck("UnaryExpression", seq(((__args45 = ["argument", checkTop]), (actions45 = [].slice.call(__args45,
        1)), seq(moveChild("argument"), seqa(actions45), up)), inspect((function(__o2) {
        var loc = __o2["loc"],
    ...
    addCheck("LetExpression", ((body14 = [((__args60 = ["bindings", checkTop]), (actions60 = [].slice.call(
