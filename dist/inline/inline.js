...
define(["require", "exports", "khepri-ast/node", "khepri-ast/declaration", "khepri-ast/statement",
    ...
    var x23 = addRewrite.bind(null, "BinaryExpression"),
        ...
        y23 = seq(((__args31 = ["left", checkTop]), (ops31 = [__args31[1]]), seq(moveChild("left"), seqa(ops31),
            ...
            ops32), up)), ((consequent6 = modify((function(__o6) {
            var operator = __o6["operator"],
                left = __o6["left"],
                right0 = __o6["right"],
    ...
    var x24 = addRewrite.bind(null, "AssignmentExpression"),
        y24 = seq(((__args33 = ["right", checkTop]), (ops33 = [__args33[1]]), seq(moveChild("right"), seqa(
            ops33), up)), ((consequent8 = extract((function(__o6) {
            var immutable = __o6["immutable"],
                left = __o6["left"],
                right0 = __o6["right"];
    ...
    var x25 = addRewrite.bind(null, ["ConditionalExpression", "IfStatement"]),
        y25 = seq(((__args34 = ["test", checkTop]), (ops34 = [__args34[1]]), seq(moveChild("test"), seqa(ops34),
            up)), ((consequent9 = extract((function(__o6) {
            var test = __o6["test"],
    ...
    var x31 = addRewrite.bind(null, "LetExpression"),
        y31 = seq(((__args47 = ["bindings", checkTop]), (ops47 = [__args47[1]]), seq(moveChild("bindings"),
            ...
            "body"), seqa(ops48), up)), ((consequent19 = modify((function(__o6) {
            var loc = __o6["loc"],
