...
*/define(["require", "exports", "bes/record", "hamt", "khepri-ast/node", "khepri-ast/declaration", "khepri-ast/statement",
    ...
    var Node = __o["Node"],
        ...
        optimize, x, y, __args, ops, consequent, __args0, ops0, __args1, ops1, __args2, ops2, __args3, ops3,
            ...
            __args32, ops32, consequent5, __args33, ops33, y0, consequent6, alternate, __args34, ops34,
            __args35, ops35, __args36, ops36, __args37, ops37, consequent7, consequent8, consequent9,
            consequent10, __args38, ops38, __args39, ops39, __args40, ops40, __args41, ops41, exp, consequent11,
            consequent12, __args42, ops42, __args43, ops43, exp0, consequent13, consequent14, __args44, ops44,
            __args45, ops45, x1, consequent15, consequent16, __args46, ops46, __args47, ops47, __args48, ops48,
            __args49, ops49, __args50, ops50, __args51, ops51, consequent17, __and = (function(x, y) {
                return (x && y);
            }),
        __plus = (function(x) {
            return (+x);
    ...
    addRewrite("MemberExpression", seq(((__args36 = ["object", checkTop]), (ops36 = [].slice.call(__args36, 1)),
        ...
        .call(__args37, 1)), (consequent7 = seq(moveChild("property"), seqa(ops37), up)), extract((
        function(node) {
    ...
    addRewrite("LetExpression", seq(((__args44 = ["bindings", checkTop]), (ops44 = [].slice.call(__args44, 1)),
        ...
        .call(__args45, 1)), seq(moveChild("body"), seqa(ops45), up)), ((x1 = type), (consequent15 =
        ...
        var z, y1;
        return (((z = node.body), (y1 = x1(z)), ("LetExpression" === y1)) ? consequent15 :
            (undefined || pass));
    }))), modify((function(__o4) {
        var loc = __o4["loc"],
            bindings = __o4["bindings"],
