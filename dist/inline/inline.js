...
define(["require", "exports", "khepri-ast/node", "khepri-ast/declaration", "khepri-ast/statement",
    ...
    var optimize, modifyNode = __o["modify"],
        ...
        x, y, __args, ops, consequent, alternate, __args0, ops0, consequent0, __args1, ops1, __args2, ops2,
            ...
            consequent10, consequent11, consequent12, consequent13, __args39, ops39, __args40, ops40, __args41,
            ops41, __args42, ops42, exp, consequent14, consequent15, __args43, ops43, __args44, ops44, exp0,
            consequent16, consequent17, __args45, ops45, __args46, ops46, consequent18, consequent19, __args47,
            ops47, __args48, ops48, __args49, ops49, __args50, ops50, __args51, ops51, __args52, ops52,
            __args53, ops53, consequent20, __and = (function(x, y) {
                return (x && y);
            }),
        __plus = (function(x) {
            return (+x);
    ...
    addRewrite("MemberExpression", seq(((__args37 = ["object", checkTop]), (ops37 = [].slice.call(__args37, 1)),
        ...
        return getBinding(getUid(id))
            .chain((function(binding) {
                return (((binding && binding.value) && binding.simple) ? set(
                    setUd("id", binding.value, node)) : pass);
            }));
    }))), extract((function(node) {
        ...
        return (((node.computed && (node.object.type === "ArrayExpression")) && isNumberish(
            node.property)) ? consequent11 : (undefined || pass));
    ...
    addRewrite("LetExpression", seq(((__args45 = ["bindings", checkTop]), (ops45 = [].slice.call(__args45, 1)),
        ...
        .call(__args46, 1)), seq(moveChild("body"), seqa(ops46), up)), ((consequent18 = modify((
        function(__o6) {
            var loc = __o6["loc"],
