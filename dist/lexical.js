...
*/define(["require", "exports", "khepri-ast/node", "khepri-ast/pattern", "khepri-ast/value", "akh/base",
    ...
    })), child("id", checkTop), child("params", checkTop), child("body", ((x4 = type), (consequent2 =
        child("body", checkTop)), (alternate2 = checkTop), inspect((function(node) {
        var y3;
    ...
    addCheck("MemberExpression", seq(child("object", checkTop), ((consequent3 = child("property", checkTop)),
