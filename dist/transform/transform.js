...
define(["require", "exports", "akh/state", "akh/base", "zipper-m/trans/tree", "ecma-ast-zipper", "../ast",
    ...
    var transform, liftM2 = __o["liftM2"],
        ...
        x, y, f, f0, y0, y1, y2, x0, x1, __args, actions, __args1, actions0, __args0, actions1, __args2,
            ...
            actions48, __args49, actions49, __args50, actions50, __args51, actions51, __args52, actions53,
    ...
    addTransform("FunctionExpression", ((actions52 = [((__args52 = ["id", checkTop]), (actions53 = [].slice.call(
        __args52, 1)), seq(moveChild("id"), sequencea(actions53), up)), modify((function(node0) {
