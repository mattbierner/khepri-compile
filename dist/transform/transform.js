...
*/define(["require", "exports", "ecma-ast/clause", "ecma-ast/declaration", "ecma-ast/expression", "ecma-ast/statement",
    ...
    addTransform("LetExpression", seq(((__args46 = ["bindings", checkTop]), (actions46 = [].slice.call(__args46,
        ...
        "body"), sequencea(actions47), up)), modify((function(node0) {
    ...
    addTransform("ArrayExpression", seq(((__args53 = ["elements", checkTop]), (actions54 = [].slice.call(
        __args53, 1)), seq(moveChild("elements"), sequencea(actions54), up)), modify((function(node0) {
    ...
    addTransform("ObjectExpression", seq(((__args54 = ["properties", checkTop]), (actions55 = [].slice.call(
        __args54, 1)), seq(moveChild("properties"), sequencea(actions55), up)), modify((function(node0) {
    ...
    addTransform("ObjectValue", seq(((__args55 = ["key", checkTop]), (actions56 = [].slice.call(__args55, 1)),
        ...
        .slice.call(__args56, 1)), seq(moveChild("value"), sequencea(actions57), up)), modify((function(
        node0) {
