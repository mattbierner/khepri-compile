...
*/define(["require", "exports", "ecma-ast/clause", "ecma-ast/declaration", "ecma-ast/expression", "ecma-ast/statement",
    ...
    var transform, ecmaZipper = __o["ecmaZipper"],
        ...
        x, y, f, f0, y0, y1, y2, x0, x1, __args, actions, __args1, actions0, __args0, actions1, __args2,
            ...
            actions48, __args49, actions50, __args50, actions51, __args51, actions52, actions49, __args52,
            actions53, __args53, actions54, __args54, actions55, __args55, actions56, __args56, actions57,
            __args57, actions58, __args58, actions59, __args59, actions60, __args60, actions61, useStrict,
            __args61, actions62, move, uid, f1, uid0, f2, _trans, M = TreeZipperT(StateT(Unique)),
    ...
    addTransform("VariableDeclarator", seq(((__args3 = ["id", checkTop]), (actions3 = [].slice.call(__args3, 1)),
        ...
        .slice.call(__args4, 1)), seq(moveChild("init"), sequencea(actions4), up)), modify((function(
        node0) {
    ...
    addTransform("BinaryExpression", seq(((__args34 = ["left", checkTop]), (actions34 = [].slice.call(__args34,
            1)), seq(moveChild("left"), sequencea(actions34), up)), ((__args35 = ["right", checkTop]), (
            actions35 = [].slice.call(__args35, 1)), seq(moveChild("right"), sequencea(actions35), up)),
        modify(translate.binaryExpression)));
    addTransform("ConditionalExpression", seq(((__args36 = ["test", checkTop]), (actions36 = [].slice.call(
        __args36, 1)), seq(moveChild("test"), sequencea(actions36), up)), ((__args37 = ["consequent",
        checkTop
    ]), (actions37 = [].slice.call(__args37, 1)), seq(moveChild("consequent"), sequencea(actions37),
        up)), ((__args38 = ["alternate", checkTop]), (actions38 = [].slice.call(__args38, 1)), seq(
        moveChild("alternate"), sequencea(actions38), up)), modify(translate.conditionalExpression)));
    addTransform("NewExpression", seq(((__args39 = ["callee", checkTop]), (actions39 = [].slice.call(__args39,
            1)), seq(moveChild("callee"), sequencea(actions39), up)), ((__args40 = ["args", checkTop]), (
            actions40 = [].slice.call(__args40, 1)), seq(moveChild("args"), sequencea(actions40), up)),
        modify(translate.newExpression)));
    addTransform("CallExpression", seq(((__args41 = ["callee", checkTop]), (actions41 = [].slice.call(__args41,
            1)), seq(moveChild("callee"), sequencea(actions41), up)), ((__args42 = ["args", checkTop]), (
            actions42 = [].slice.call(__args42, 1)), seq(moveChild("args"), sequencea(actions42), up)),
        modify(translate.callExpression)));
    addTransform("MemberExpression", seq(((__args43 = ["object", checkTop]), (actions43 = [].slice.call(
        __args43, 1)), seq(moveChild("object"), sequencea(actions43), up)), ((__args44 = ["property",
        checkTop
    ]), (actions44 = [].slice.call(__args44, 1)), seq(moveChild("property"), sequencea(actions44),
        up)), modify(translate.memberExpression)));
    addTransform("LetExpression", seq(((__args45 = ["bindings", checkTop]), (actions45 = [].slice.call(__args45,
        1)), seq(moveChild("bindings"), sequencea(actions45), up)), withNode((function(z) {
        return addBindingsForBindingsList(z.bindings);
    })), ((__args46 = ["body", checkTop]), (actions46 = [].slice.call(__args46, 1)), seq(moveChild(
        "body"), sequencea(actions46), up)), modify((function(node0) {
        return translate.letExpression(node0.loc, node0.bindings, node0.body);
    }))));
    addTransform("CurryExpression", seq(((__args47 = ["base", checkTop]), (actions47 = [].slice.call(__args47,
            1)), seq(moveChild("base"), sequencea(actions47), up)), ((__args48 = ["args", checkTop]), (
            actions48 = [].slice.call(__args48, 1)), seq(moveChild("args"), sequencea(actions48), up)),
        modify((function(node0) {
            return translate.curryExpression(node0.loc, node0.base, node0.args);
        }))));
    addTransform("FunctionExpression", ((actions49 = [((__args49 = ["id", checkTop]), (actions50 = [].slice.call(
        __args49, 1)), seq(moveChild("id"), sequencea(actions50), up)), modify((function(node0) {
        return translate.functionExpression(node0.loc, node0.id, node0.params, node0.body,
            getUd("prefix", node0));
    })), ((__args50 = ["params", checkTop]), (actions51 = [].slice.call(__args50, 1)), seq(
        moveChild("params"), sequencea(actions51), up)), ((__args51 = ["body", checkTop]), (
        actions52 = [].slice.call(__args51, 1)), seq(moveChild("body"), sequencea(actions52),
    ...
    addTransform("ArrayExpression", seq(((__args52 = ["elements", checkTop]), (actions53 = [].slice.call(
        __args52, 1)), seq(moveChild("elements"), sequencea(actions53), up)), modify((function(node0) {
        return ecma_expression.ArrayExpression.create(node0.loc, node0.elements);
    }))));
    addTransform("ObjectExpression", seq(((__args53 = ["properties", checkTop]), (actions54 = [].slice.call(
        __args53, 1)), seq(moveChild("properties"), sequencea(actions54), up)), modify((function(node0) {
        return ecma_expression.ObjectExpression.create(node0.loc, node0.properties);
    }))));
    addTransform("ObjectValue", seq(((__args54 = ["key", checkTop]), (actions55 = [].slice.call(__args54, 1)),
        seq(moveChild("key"), sequencea(actions55), up)), ((__args55 = ["value", checkTop]), (actions56 = []
        .slice.call(__args55, 1)), seq(moveChild("value"), sequencea(actions56), up)), modify((function(
        node0) {
        return ecma_value.ObjectValue.create(node0.loc, node0.key, node0.value);
    }))));
    addTransform(["RelativeUnpack", "SliceUnpack"], ((__args56 = ["target", checkTop]), (actions57 = [].slice.call(
        __args56, 1)), seq(moveChild("target"), sequencea(actions57), up)));
    addTransform("ArgumentsPattern", seq(((__args57 = ["id", checkTop]), (actions58 = [].slice.call(__args57, 1)),
        seq(moveChild("id"), sequencea(actions58), up)), ((__args58 = ["elements", checkTop]), (
        actions59 = [].slice.call(__args58, 1)), seq(moveChild("elements"), sequencea(actions59),
        up)), ((__args59 = ["self", checkTop]), (actions60 = [].slice.call(__args59, 1)), seq(moveChild(
        "self"), sequencea(actions60), up))));
    ...
    })), ((__args61 = ["body", checkTop]), (actions62 = [].slice.call(__args61, 1)), seq(moveChild(
        "body"), sequencea(actions62), up)), getBindings((function(bindings) {
