...
*/define(["require", "exports", "ecma-ast/clause", "ecma-ast/declaration", "ecma-ast/expression", "ecma-ast/node",
    ...
    var type = __o["type"],
        ...
        program, assignmentExpression, unaryExpression, binaryExpression, logicalExpression,
            conditionalExpression, newExpression, callExpression, memberExpression, blockStatement,
            withStatement, functionExpression, letExpression, curryExpression, packageBlock, x, y, x0, y0, x1,
            y1, identifier = (function(loc, name, uid) {
