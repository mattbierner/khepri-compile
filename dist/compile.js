...
define(["require", "exports", "./stages/pre_normalize", "./stages/lexical", "./stages/post_normalize",
    ...
    "use strict";
    var compile, x, x0, x1, x2, x3, x4, y, f, g, y0, f0, g0, y1, f1, g1, y2, f2, g2, y3, f3, g3, y4, f4, g4,
            compiler = ((x = pre_normalize), (x0 = lexical), (x1 = post_normalize), (x2 = inline), (x3 =
                khepri_peep), (x4 = transform), (y = ecma_peep), (f = y), (g = x4), (y0 = (function(x) {
                return f(g(x));
