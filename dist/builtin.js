...
define(["require", "exports", "khepri-ast/pattern", "khepri-ast/expression", "khepri-ast/value", "./ast", "./fun"], (
    function(require, exports, ast_pattern, ast_expression, ast_value, __o, __o0) {
        ...
        var uid3 = unique(),
            ...
            node = ast_expression.FunctionExpression.create(null, null, ast_pattern.ArgumentsPattern.create(null,
                    null, [ast_pattern.IdentifierPattern.create(null, xArg), ast_pattern.IdentifierPattern.create(
        ...
        var binary = (function(op) {
            var xArg0 = identifier("x", unique()),
                ...
                node0 = ast_expression.FunctionExpression.create(null, null, ast_pattern.ArgumentsPattern.create(
        ...
        (member = (function(id, uid6) {
            var xArg0 = identifier("x", uid6),
                node0 = ast_expression.FunctionExpression.create(null, null, ast_pattern.ArgumentsPattern.create(
                    ...
                    .create(null, xArg0, identifier(id), false)),
