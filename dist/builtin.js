    ...
    function(require, exports, ast_pattern, ast_expression, ast_value, __o, __o0) {
        ...
        registerBinary(".?", "__cdot", (function(x, y) {
            return ast_expression.BinaryExpression.create(null, "&&", x, setUd("id", identifier("__x",
                unique()), ast_expression.MemberExpression.create(null, x, y, true)));
        }));
        ...
        (member = (function(id, uid10) {
            var xArg2 = identifier("x", uid10),
                node2 = ast_expression.FunctionExpression.create(null, null, ast_pattern.ArgumentsPattern.create(
                        null, null, [ast_pattern.IdentifierPattern.create(null, xArg2)]), ast_expression.MemberExpression
                    .create(null, xArg2, identifier(id), false)),
