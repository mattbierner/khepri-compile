...
define(["require", "exports", "khepri-ast/expression", "khepri-ast/node", "khepri-ast/pattern", "khepri-ast/value",
    "./ast", "./fun"
], (function(require, exports, ast_expression, __o, ast_pattern, ast_value, __o0, __o1) {
    "use strict";
    ...
    forEach([
        ...
        registerAliasedSymbol(op, name, ((uid3 = unique()), (xArg = setUid(uid3, ast_value.Identifier.create(
            null, "x"))), setLocals([getUid(xArg)], ast_expression.FunctionExpression.create(
            null, null, ast_pattern.ArgumentsPattern.create(null, null, [ast_pattern.IdentifierPattern
                .create(null, xArg)
    ...
    var uid3 = unique(),
        ...
        ternaryOperator = setLocals([getUid(xArg), getUid(yArg), getUid(zArg)], ast_expression.FunctionExpression
    ...
    var binary = (function(op) {
        ...
        return setLocals([getUid(xArg0), getUid(yArg0)], ast_expression.FunctionExpression.create(null,
            null, ast_pattern.ArgumentsPattern.create(null, null, [ast_pattern.IdentifierPattern.create(
                null, xArg0), ast_pattern.IdentifierPattern.create(null, yArg0)]), op(xArg0, yArg0)));
    }),
    ...
    registerAliasedSymbol("_", "_", ((uid6 = unique()), (xArg0 = setUid(uid6, ast_value.Identifier.create(null,
        "f"))), setLocals([getUid(xArg0)], ast_expression.FunctionExpression.create(null, null,
        ast_pattern.ArgumentsPattern.create(null, null, [ast_pattern.IdentifierPattern.create(null,
            xArg0)]), ((uid7 = unique()), (xArg1 = setUid(uid7, ast_value.Identifier.create(null,
            "x"))), (uid8 = unique()), (yArg0 = setUid(uid8, ast_value.Identifier.create(null,
            "y"))), setLocals([getUid(xArg1), getUid(yArg0)], ast_expression.FunctionExpression
    ...
    registerBinary("??", "__chk", (function(x, y) {
        return ast_expression.BinaryExpression.create(null, "&&", x, ast_expression.CallExpression.create(
            null, y, [x]));
    }));
    ...
    var pipe0 = (function(callee, arg) {
        return ast_expression.CallExpression.create(null, ast_expression.MemberExpression.create(null,
            callee, setUid(undefined, ast_value.Identifier.create(null, "apply"))), [ast_value.Literal.create(
            null, "null"), arg]);
    });
    ...
    var multiCompose = (function(f, g) {
        ...
        return setLocals([getUid(args)], ast_expression.FunctionExpression.create(null, null, ast_pattern.ArgumentsPattern
            ...
            .create(null, f, [ast_expression.CallExpression.create(null, ast_expression.MemberExpression
                .create(null, g, setUid(undefined, ast_value.Identifier.create(null, "apply"))), [
