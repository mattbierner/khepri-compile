...
define(["require", "exports", "khepri-ast/node", "akh/base", "../fun", "../ast", "./state", "./m"], (function(require,
    ...
    addRewrite("OperatorExpression", ((__args47 = ["operator", checkTop]), (actions47 = [].slice.call(__args47,
        1)), seq(moveChild("operator"), sequencea(actions47), up)));
    addRewrite("LetExpression", seq(((__args48 = ["body", checkTop]), (actions48 = [].slice.call(__args48, 1)),
        seq(moveChild("body"), sequencea(actions48), up)), ((__args49 = ["bindings", checkTop]), (
        actions49 = [].slice.call(__args49, 1)), seq(moveChild("bindings"), sequencea(actions49),
        up))));
    ...
    addRewrite("ArrayExpression", ((__args51 = ["elements", checkTop]), (actions51 = [].slice.call(__args51, 1)),
        seq(moveChild("elements"), sequencea(actions51), up)));
    addRewrite("ObjectExpression", ((__args52 = ["properties", checkTop]), (actions52 = [].slice.call(__args52,
        1)), seq(moveChild("properties"), sequencea(actions52), up)));
    addRewrite("ObjectValue", ((__args53 = ["value", checkTop]), (actions53 = [].slice.call(__args53, 1)), seq(
        moveChild("value"), sequencea(actions53), up)));
