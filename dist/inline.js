...
define(["require", "exports", "bes/record", "hashtrie", "khepri-ast-zipper", "khepri-ast/node",
    ...
    addRewrite("VariableDeclarator", seq(visitChild("init"), node.chain((function(node0) {
        return (node0.init ? (node0.immutable ? addBindingForNode(node0.id, node0.init) :
    ...
    addRewrite("Binding", seq(visitChild("value"), when((function(node0) {
        ...
        return addBindingForNode(node0.pattern.id, node0.value);
    }))), when((function(node0) {
    ...
    addRewrite("MemberExpression", seq(visitChild("object"), node.chain((function(node0) {
        return (node0.computed ? visitChild("property") : pass);
    })), when((function(node0) {
