...
var record = require("bes")["record"],
    ...
    optimize, x, y, test, consequent, alternate, test0, consequent0, alternate0, test1, consequent1, alternate1,
        ...
        alternate13, test14, consequent14, alternate14, _check, Binding = record.declare(null, ["value", "immutable",
            "simple"
        ]),
...
var M = ZipperT(StateT(Unique)),
    ...
    expandNode = (function(node0, f) {
        var uid, exp;
        return (getExpansion(node0) ? ((uid = getUid(node0)), (exp = getExpansion(node0)), getCtx.map((function(ctx) {
                return ((exp.count < 1) && (hashtrie.get(uid, ctx) < 1));
            }))
            .chain((function(can) {
    ...
    addBindingForNode = (function(id, value) {
        ...
        return (isPrimitive(value) ? addBinding(uid, value, true) : (isLambda(value) ? addBinding(uid,
            ...
            .chain((function(binding0) {
                return (binding0 ? ((binding0.simple && binding0.immutable) ? addBinding(uid,
                        binding0.value, binding0.simple) : addBinding(uid, value, false)) :
...
addRewrite("VariableDeclarator", seq(child("init", checkTop), ((test = (function(node0) {
    ...
    return (node0.immutable ? seq(addBindingForNode(node0.id, node0.init), tryPrune(node0.id)) :
        addWorking(getUid(node0.id), node0.init, ((isPrimitive(node0.init) || isIdentifier(
            node0.init)) || isLambda(node0.init))));
...
addRewrite("Binding", seq(child("value", checkTop), ((test0 = (function(node0) {
    ...
    return seq(addBindingForNode(node0.pattern.id, node0.value), tryPrune(node0.pattern.id));
...
addRewrite("CallExpression", seq(child("callee", checkTop), child("args", checkTop), ((test9 = (function(node0) {
    ...
    var node1;
    return (((node1 = node0), getExpansion(node1.callee)) ? consequent9 : (alternate9 || pass));
...
addRewrite("CurryExpression", seq(child("base", checkTop), child("args", checkTop), ((test11 = (function(node0) {
    ...
    var node1;
    return (((node1 = node0), getExpansion(node1.base)) ? consequent11 : (alternate11 || pass));
...
addRewrite("Identifier", ((test14 = (function(node0) {
    ...
    var node1;
    return (((node1 = node0), (getUid(node1) && (!getExpansion(node1)))) ? consequent14 : (alternate14 ||
        pass));
}))));
