...
var StateT = require("akh")["trans"]["state"],
    ...
    y3 = seq(((__args = ["declarations", checkTop]), (actions = [__args[1]]), seq(moveChild("declarations"), sequencea(
        actions), up)), modify(translate.variableDeclaration));
x2(y3);
var x3 = addTransform.bind(null, "Binding"),
    y4 = seq(((__args0 = ["pattern", ((__args1 = ["id", checkTop]), (actions0 = [__args1[1]]), seq(moveChild("id"),
        sequencea(actions0), up))]), (actions1 = [__args0[1]]), seq(moveChild("pattern"), sequencea(actions1),
        up)), ((__args2 = ["value", checkTop]), (actions2 = [__args2[1]]), seq(moveChild("value"), sequencea(
        actions2), up)));
x3(y4);
var x4 = addTransform.bind(null, "VariableDeclarator"),
    y5 = seq(((__args3 = ["id", checkTop]), (actions3 = [__args3[1]]), seq(moveChild("id"), sequencea(actions3), up)), (
            (__args4 = ["init", checkTop]), (actions4 = [__args4[1]]), seq(moveChild("init"), sequencea(actions4), up)),
...
var x6 = addTransform.bind(null, "CatchClause"),
    y7 = seq(((__args5 = ["param", checkTop]), (actions5 = [__args5[1]]), seq(moveChild("param"), sequencea(actions5),
        up)), ((__args6 = ["body", checkTop]), (actions6 = [__args6[1]]), seq(moveChild("body"), sequencea(actions6),
        up)), modify(translate.catchClause));
x6(y7);
var x7 = addTransform.bind(null, "SwitchCase"),
    y8 = seq(((__args7 = ["test", checkTop]), (actions7 = [__args7[1]]), seq(moveChild("test"), sequencea(actions7), up)), (
        (__args8 = ["consequent", checkTop]), (actions8 = [__args8[1]]), seq(moveChild("consequent"), sequencea(
            actions8), up)), modify(translate.switchCase));
x7(y8);
var x8 = addTransform.bind(null, "BlockStatement"),
    y9 = seq(pushBindings, ((__args9 = ["body", checkTop]), (actions9 = [__args9[1]]), seq(moveChild("body"), sequencea(
        actions9), up)), getBindings((function(bindings) {
        return modify(translate.blockStatement.bind(null, bindings));
    })), popBindings);
x8(y9);
var x9 = addTransform.bind(null, "ExpressionStatement"),
    y10 = seq(((__args10 = ["expression", checkTop]), (actions10 = [__args10[1]]), seq(moveChild("expression"),
        sequencea(actions10), up)), modify(translate.expressionStatement));
x9(y10);
var x10 = addTransform.bind(null, "IfStatement"),
    y11 = seq(((__args11 = ["test", checkTop]), (actions11 = [__args11[1]]), seq(moveChild("test"), sequencea(actions11),
        up)), ((__args12 = ["consequent", checkTop]), (actions12 = [__args12[1]]), seq(moveChild("consequent"),
        sequencea(actions12), up)), ((__args13 = ["alternate", checkTop]), (actions13 = [__args13[1]]), seq(
        moveChild("alternate"), sequencea(actions13), up)), modify(translate.ifStatement));
x10(y11);
var x11 = addTransform.bind(null, "WithStatement"),
    y12 = seq(((__args14 = ["bindings", checkTop]), (actions14 = [__args14[1]]), seq(moveChild("bindings"), sequencea(
        actions14), up)), ((__args15 = ["body", checkTop]), (actions15 = [__args15[1]]), seq(moveChild("body"),
        sequencea(actions15), up)), modify(translate.withStatement));
x11(y12);
var x12 = addTransform.bind(null, "SwitchStatement"),
    y13 = seq(((__args16 = ["discriminant", checkTop]), (actions16 = [__args16[1]]), seq(moveChild("discriminant"),
        sequencea(actions16), up)), ((__args17 = ["cases", checkTop]), (actions17 = [__args17[1]]), seq(moveChild(
        "cases"), sequencea(actions17), up)), modify(translate.switchStatement));
x12(y13);
var x13 = addTransform.bind(null, "ReturnStatement"),
    y14 = seq(((__args18 = ["argument", checkTop]), (actions18 = [__args18[1]]), seq(moveChild("argument"), sequencea(
        actions18), up)), modify(translate.returnStatement));
x13(y14);
var x14 = addTransform.bind(null, "ThrowStatement"),
    y15 = seq(((__args19 = ["argument", checkTop]), (actions19 = [__args19[1]]), seq(moveChild("argument"), sequencea(
        actions19), up)), modify(translate.throwStatement));
x14(y15);
...
var x17 = addTransform.bind(null, "TryStatement"),
    y18 = seq(((__args20 = ["block", checkTop]), (actions20 = [__args20[1]]), seq(moveChild("block"), sequencea(
        actions20), up)), ((__args21 = ["handler", checkTop]), (actions21 = [__args21[1]]), seq(moveChild("handler"),
        sequencea(actions21), up)), ((__args22 = ["finalizer", checkTop]), (actions22 = [__args22[1]]), seq(
        moveChild("finalizer"), sequencea(actions22), up)), modify(translate.tryStatement));
x17(y18);
var x18 = addTransform.bind(null, "WhileStatement"),
    y19 = seq(((__args23 = ["test", checkTop]), (actions23 = [__args23[1]]), seq(moveChild("test"), sequencea(actions23),
        up)), loopBlock(((__args24 = ["body", checkTop]), (actions24 = [__args24[1]]), seq(moveChild("body"),
        sequencea(actions24), up))), modify(translate.whileStatement));
x18(y19);
var x19 = addTransform.bind(null, "DoWhileStatement"),
    y20 = seq(loopBlock(((__args25 = ["body", checkTop]), (actions25 = [__args25[1]]), seq(moveChild("body"), sequencea(
        actions25), up))), ((__args26 = ["test", checkTop]), (actions26 = [__args26[1]]), seq(moveChild("test"),
        sequencea(actions26), up)), modify(translate.doWhileStatement));
x19(y20);
var x20 = addTransform.bind(null, "ForStatement"),
    y21 = seq(((__args27 = ["init", checkTop]), (actions27 = [__args27[1]]), seq(moveChild("init"), sequencea(actions27),
        up)), ((__args28 = ["test", checkTop]), (actions28 = [__args28[1]]), seq(moveChild("test"), sequencea(
        actions28), up)), ((__args29 = ["update", checkTop]), (actions29 = [__args29[1]]), seq(moveChild("update"),
        sequencea(actions29), up)), loopBlock(((__args30 = ["body", checkTop]), (actions30 = [__args30[1]]), seq(
        moveChild("body"), sequencea(actions30), up))), modify(translate.forStatement));
x20(y21);
var x21 = addTransform.bind(null, "AssignmentExpression"),
    y22 = seq(((__args31 = ["left", checkTop]), (actions31 = [__args31[1]]), seq(moveChild("left"), sequencea(actions31),
        up)), ((__args32 = ["right", checkTop]), (actions32 = [__args32[1]]), seq(moveChild("right"), sequencea(
        actions32), up)), modify(translate.assignmentExpression));
x21(y22);
