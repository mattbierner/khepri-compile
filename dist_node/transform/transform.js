...
addTransform("VariableDeclaration", seq(((__args = ["declarations", checkTop]), (actions = [].slice.call(__args, 1)),
    seq(moveChild("declarations"), sequencea(actions), up)), modify(translate.variableDeclaration)));
addTransform("Binding", seq(((__args0 = ["pattern", ((__args1 = ["id", checkTop]), (actions0 = [].slice.call(__args1, 1)),
    seq(moveChild("id"), sequencea(actions0), up))]), (actions1 = [].slice.call(__args0, 1)), seq(moveChild(
    "pattern"), sequencea(actions1), up)), ((__args2 = ["value", checkTop]), (actions2 = [].slice.call(__args2,
    1)), seq(moveChild("value"), sequencea(actions2), up))));
addTransform("VariableDeclarator", seq(((__args3 = ["id", checkTop]), (actions3 = [].slice.call(__args3, 1)), seq(
    moveChild("id"), sequencea(actions3), up)), ((__args4 = ["init", checkTop]), (actions4 = [].slice.call(
    __args4, 1)), seq(moveChild("init"), sequencea(actions4), up)), modify(translate.variableDeclarator)));
addTransform("StaticDeclaration", modify(translate.emptyStatement));
addTransform("CatchClause", seq(((__args5 = ["param", checkTop]), (actions5 = [].slice.call(__args5, 1)), seq(moveChild(
    "param"), sequencea(actions5), up)), ((__args6 = ["body", checkTop]), (actions6 = [].slice.call(__args6, 1)),
    seq(moveChild("body"), sequencea(actions6), up)), modify(translate.catchClause)));
addTransform("SwitchCase", seq(((__args7 = ["test", checkTop]), (actions7 = [].slice.call(__args7, 1)), seq(moveChild(
    "test"), sequencea(actions7), up)), ((__args8 = ["consequent", checkTop]), (actions8 = [].slice.call(
    __args8, 1)), seq(moveChild("consequent"), sequencea(actions8), up)), modify(translate.switchCase)));
addTransform("BlockStatement", seq(pushBindings, ((__args9 = ["body", checkTop]), (actions9 = [].slice.call(__args9, 1)),
    seq(moveChild("body"), sequencea(actions9), up)), getBindings((function(bindings) {
    return modify(translate.blockStatement.bind(null, bindings));
})), popBindings));
addTransform("ExpressionStatement", seq(((__args10 = ["expression", checkTop]), (actions10 = [].slice.call(__args10, 1)),
    seq(moveChild("expression"), sequencea(actions10), up)), modify(translate.expressionStatement)));
addTransform("IfStatement", seq(((__args11 = ["test", checkTop]), (actions11 = [].slice.call(__args11, 1)), seq(
    moveChild("test"), sequencea(actions11), up)), ((__args12 = ["consequent", checkTop]), (actions12 = [].slice
    .call(__args12, 1)), seq(moveChild("consequent"), sequencea(actions12), up)), ((__args13 = ["alternate",
    checkTop
]), (actions13 = [].slice.call(__args13, 1)), seq(moveChild("alternate"), sequencea(actions13), up)), modify(
    translate.ifStatement)));
addTransform("WithStatement", seq(((__args14 = ["bindings", checkTop]), (actions14 = [].slice.call(__args14, 1)), seq(
    moveChild("bindings"), sequencea(actions14), up)), ((__args15 = ["body", checkTop]), (actions15 = [].slice.call(
    __args15, 1)), seq(moveChild("body"), sequencea(actions15), up)), modify(translate.withStatement)));
addTransform("SwitchStatement", seq(((__args16 = ["discriminant", checkTop]), (actions16 = [].slice.call(__args16, 1)),
    seq(moveChild("discriminant"), sequencea(actions16), up)), ((__args17 = ["cases", checkTop]), (actions17 = []
    .slice.call(__args17, 1)), seq(moveChild("cases"), sequencea(actions17), up)), modify(translate.switchStatement)));
addTransform("ReturnStatement", seq(((__args18 = ["argument", checkTop]), (actions18 = [].slice.call(__args18, 1)), seq(
    moveChild("argument"), sequencea(actions18), up)), modify(translate.returnStatement)));
addTransform("ThrowStatement", seq(((__args19 = ["argument", checkTop]), (actions19 = [].slice.call(__args19, 1)), seq(
    moveChild("argument"), sequencea(actions19), up)), modify(translate.throwStatement)));
...
addTransform("TryStatement", seq(((__args20 = ["block", checkTop]), (actions20 = [].slice.call(__args20, 1)), seq(
    moveChild("block"), sequencea(actions20), up)), ((__args21 = ["handler", checkTop]), (actions21 = [].slice.call(
    __args21, 1)), seq(moveChild("handler"), sequencea(actions21), up)), ((__args22 = ["finalizer", checkTop]), (
...
addTransform("UnaryExpression", seq(((__args33 = ["argument", checkTop]), (actions33 = [].slice.call(__args33, 1)), seq(
    moveChild("argument"), sequencea(actions33), up)), modify(translate.unaryExpression)));
addTransform("BinaryExpression", seq(((__args34 = ["operator", checkTop]), (actions34 = [].slice.call(__args34, 1)),
    seq(moveChild("operator"), sequencea(actions34), up)), ((__args35 = ["left", checkTop]), (actions35 = [].slice
    .call(__args35, 1)), seq(moveChild("left"), sequencea(actions35), up)), ((__args36 = ["right", checkTop]), (
    actions36 = [].slice.call(__args36, 1)), seq(moveChild("right"), sequencea(actions36), up)), modify(
    translate.binaryExpression)));
addTransform("ConditionalExpression", seq(((__args37 = ["test", checkTop]), (actions37 = [].slice.call(__args37, 1)),
    seq(moveChild("test"), sequencea(actions37), up)), ((__args38 = ["consequent", checkTop]), (actions38 = [].slice
    .call(__args38, 1)), seq(moveChild("consequent"), sequencea(actions38), up)), ((__args39 = ["alternate",
    checkTop
]), (actions39 = [].slice.call(__args39, 1)), seq(moveChild("alternate"), sequencea(actions39), up)), modify(
    translate.conditionalExpression)));
addTransform("NewExpression", seq(((__args40 = ["callee", checkTop]), (actions40 = [].slice.call(__args40, 1)), seq(
    moveChild("callee"), sequencea(actions40), up)), ((__args41 = ["args", checkTop]), (actions41 = [].slice.call(
...
addTransform("CheckedMemberExpression", seq(((__args46 = ["object", checkTop]), (actions46 = [].slice.call(__args46, 1)),
        seq(moveChild("object"), sequencea(actions46), up)), ((__args47 = ["property", checkTop]), (actions47 = [].slice
        .call(__args47, 1)), seq(moveChild("property"), sequencea(actions47), up)), modify(translate.checkedMemberExpression),
    checkTop));
addTransform("LetExpression", seq(((__args48 = ["bindings", checkTop]), (actions48 = [].slice.call(__args48, 1)), seq(
    moveChild("bindings"), sequencea(actions48), up)), withNode((function(z) {
    return addBindingsForBindingsList(z.bindings);
})), ((__args49 = ["body", checkTop]), (actions49 = [].slice.call(__args49, 1)), seq(moveChild("body"),
    sequencea(actions49), up)), modify(translate.letExpression)));
...
addTransform("ObjectExpression", seq(((__args56 = ["properties", checkTop]), (actions57 = [].slice.call(__args56, 1)),
    seq(moveChild("properties"), sequencea(actions57), up)), modify(translate.objectExpression)));
addTransform("ObjectValue", seq(((__args57 = ["key", checkTop]), (actions58 = [].slice.call(__args57, 1)), seq(
    moveChild("key"), sequencea(actions58), up)), ((__args58 = ["value", checkTop]), (actions59 = [].slice.call(
    __args58, 1)), seq(moveChild("value"), sequencea(actions59), up)), modify(translate.objectValue)));
addTransform("IdentifierPattern", seq(((__args59 = ["id", checkTop]), (actions60 = [].slice.call(__args59, 1)), seq(
    moveChild("id"), sequencea(actions60), up)), modify((function(x2) {
    return x2.id;
}))));
addTransform(["RelativeUnpack", "SliceUnpack"], ((__args60 = ["target", checkTop]), (actions61 = [].slice.call(__args60,
    1)), seq(moveChild("target"), sequencea(actions61), up)));
addTransform("ArgumentsPattern", seq(((__args61 = ["id", checkTop]), (actions62 = [].slice.call(__args61, 1)), seq(
    moveChild("id"), sequencea(actions62), up)), ((__args62 = ["elements", checkTop]), (actions63 = [].slice.call(
    __args62, 1)), seq(moveChild("elements"), sequencea(actions63), up)), ((__args63 = ["self", checkTop]), (
    actions64 = [].slice.call(__args63, 1)), seq(moveChild("self"), sequencea(actions64), up))));
...
})), ((__args64 = ["body", checkTop]), (actions65 = [].slice.call(__args64, 1)), seq(moveChild("body"),
    sequencea(actions65), up)), getBindings((function(bindings) {
