...
var __o = require("khepri-ast")["node"],
    ...
    runReachable = __o3["runReachable"],
    ...
    run = runReachable.bind(null, state.Empty),
    pass = M.of(null),
    extractCtx = M.get,
    inspect = flip(M.map)
        .bind(null, M.node),
...
addRewrite("Binding", ((__args10 = ["value", checkTop]), (actions10 = [].slice.call(__args10, 1)), (consequent = seq(
    moveChild("value"), sequencea(actions10), up)), (test0 = inspect((function(z) {
    return getUid(z.pattern.id);
}))), (__args11 = ["value", checkTop]), (actions11 = [].slice.call(__args11, 1)), (yes0 = seq(moveChild("value"),
    sequencea(actions11), up)), (no0 = removeBinding), (alternate = test0.chain((function(uid) {
    return getState.chain((function(s) {
...
addRewrite(["MemberExpression", "CheckedMemberExpression"], seq(((__args39 = ["object", checkTop]), (actions39 = [].slice
    .call(__args39, 1)), seq(moveChild("object"), sequencea(actions39), up)), ((__args40 = ["property",
    checkTop
]), (actions40 = [].slice.call(__args40, 1)), (consequent0 = seq(moveChild("property"), sequencea(actions40),
