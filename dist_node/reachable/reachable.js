...
addRewrite("Binding", ((test0 = inspect(((y1 = getUid), (function(z) {
    ...
    "value"), sequencea(actions10), up)), (no0 = removeBinding), test0.chain((function(uid) {
    return getState.chain((function(s) {
...
addRewrite("BlockStatement", ((__args11 = ["body", checkTop]), (actions11 = [].slice.call(__args11, 1)), seq(moveChild(
    "body"), sequencea(actions11), up)));
addRewrite("ExpressionStatement", ((__args12 = ["expression", checkTop]), (actions12 = [].slice.call(__args12, 1)), seq(
    moveChild("expression"), sequencea(actions12), up)));
addRewrite("WithStatement", seq(((__args13 = ["body", checkTop]), (actions13 = [].slice.call(__args13, 1)), seq(
    moveChild("body"), sequencea(actions13), up)), ((__args14 = ["bindings", checkTop]), (actions14 = [].slice.call(
    __args14, 1)), seq(moveChild("bindings"), sequencea(actions14), up))));
addRewrite("SwitchStatement", seq(((__args15 = ["discriminant", checkTop]), (actions15 = [].slice.call(__args15, 1)),
    seq(moveChild("discriminant"), sequencea(actions15), up)), ((__args16 = ["cases", checkTop]), (actions16 = []
    .slice.call(__args16, 1)), seq(moveChild("cases"), sequencea(actions16), up))));
addRewrite(["ReturnStatement", "ThrowStatement"], ((__args17 = ["argument", checkTop]), (actions17 = [].slice.call(
    __args17, 1)), seq(moveChild("argument"), sequencea(actions17), up)));
addRewrite("TryStatement", seq(((__args18 = ["block", checkTop]), (actions18 = [].slice.call(__args18, 1)), seq(
    moveChild("block"), sequencea(actions18), up)), ((__args19 = ["handler", checkTop]), (actions19 = [].slice.call(
    __args19, 1)), seq(moveChild("handler"), sequencea(actions19), up)), ((__args20 = ["finalizer", checkTop]), (
    actions20 = [].slice.call(__args20, 1)), seq(moveChild("finalizer"), sequencea(actions20), up))));
addRewrite(["WhileStatement", "DoWhileStatement"], seq(((__args21 = ["test", checkTop]), (actions21 = [].slice.call(
    __args21, 1)), seq(moveChild("test"), sequencea(actions21), up)), ((__args22 = ["body", checkTop]), (
...
addRewrite("ForStatement", seq(((__args23 = ["body", checkTop]), (actions23 = [].slice.call(__args23, 1)), seq(
    moveChild("body"), sequencea(actions23), up)), ((__args24 = ["update", checkTop]), (actions24 = [].slice.call(
    __args24, 1)), seq(moveChild("update"), sequencea(actions24), up)), ((__args25 = ["test", checkTop]), (
    actions25 = [].slice.call(__args25, 1)), seq(moveChild("test"), sequencea(actions25), up)), ((__args26 = [
    "init", checkTop
]), (actions26 = [].slice.call(__args26, 1)), seq(moveChild("init"), sequencea(actions26), up))));
addRewrite(["ConditionalExpression", "IfStatement"], seq(((__args27 = ["test", checkTop]), (actions27 = [].slice.call(
    __args27, 1)), seq(moveChild("test"), sequencea(actions27), up)), ((__args28 = ["consequent", checkTop]), (
    actions28 = [].slice.call(__args28, 1)), seq(moveChild("consequent"), sequencea(actions28), up)), ((
    __args29 = ["alternate", checkTop]), (actions29 = [].slice.call(__args29, 1)), seq(moveChild(
    "alternate"), sequencea(actions29), up))));
addRewrite("FunctionExpression", seq(((__args30 = ["body", checkTop]), (actions30 = [].slice.call(__args30, 1)), seq(
    moveChild("body"), sequencea(actions30), up)), ((__args31 = ["id", checkTop]), (actions31 = [].slice.call(
    __args31, 1)), seq(moveChild("id"), sequencea(actions31), up)), ((__args32 = ["params", checkTop]), (
    actions32 = [].slice.call(__args32, 1)), seq(moveChild("params"), sequencea(actions32), up))));
addRewrite("UnaryExpression", ((__args33 = ["argument", checkTop]), (actions33 = [].slice.call(__args33, 1)), seq(
    moveChild("argument"), sequencea(actions33), up)));
addRewrite(["LogicalExpression", "BinaryExpression"], seq(((__args34 = ["left", checkTop]), (actions34 = [].slice.call(
    __args34, 1)), seq(moveChild("left"), sequencea(actions34), up)), ((__args35 = ["right", checkTop]), (
...
addRewrite("AssignmentExpression", seq(((__args36 = ["left", checkTop]), (actions36 = [].slice.call(__args36, 1)), seq(
    ...
    __args37, 1)), seq(moveChild("right"), sequencea(actions37), up))));
addRewrite("MemberExpression", seq(((__args38 = ["object", checkTop]), (actions38 = [].slice.call(__args38, 1)), seq(
    moveChild("object"), sequencea(actions38), up)), ((__args39 = ["property", checkTop]), (actions39 = [].slice
    .call(__args39, 1)), (consequent = seq(moveChild("property"), sequencea(actions39), up)), extract((
    function(node) {
...
addRewrite("NewExpression", seq(((__args40 = ["callee", checkTop]), (actions40 = [].slice.call(__args40, 1)), seq(
    ...
    __args41, 1)), seq(moveChild("args"), sequencea(actions41), up))));
addRewrite("CallExpression", seq(((__args42 = ["callee", checkTop]), (actions42 = [].slice.call(__args42, 1)), seq(
    ...
    __args43, 1)), seq(moveChild("args"), sequencea(actions43), up))));
addRewrite("CurryExpression", seq(((__args44 = ["base", checkTop]), (actions44 = [].slice.call(__args44, 1)), seq(
    moveChild("base"), sequencea(actions44), up)), ((__args45 = ["args", checkTop]), (actions45 = [].slice.call(
    __args45, 1)), seq(moveChild("args"), sequencea(actions45), up))));
addRewrite("LetExpression", seq(((__args46 = ["body", checkTop]), (actions46 = [].slice.call(__args46, 1)), seq(
    moveChild("body"), sequencea(actions46), up)), ((__args47 = ["bindings", checkTop]), (actions47 = [].slice.call(
    __args47, 1)), seq(moveChild("bindings"), sequencea(actions47), up))));
addRewrite(["SliceUnpack", "RelativeUnpack"], ((__args48 = ["target", checkTop]), (actions48 = [].slice.call(__args48,
    1)), seq(moveChild("target"), sequencea(actions48), up)));
