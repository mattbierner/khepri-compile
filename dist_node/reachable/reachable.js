...
var __o = require("khepri-ast")["node"],
    ...
    removeUnreachable, x, y, move, __args, actions, __args0, actions0, __args1, actions1, __args2, actions2, __args3,
        ...
        actions26, __args27, actions27, __args28, actions28, __args29, actions29, __args30, actions30, __args31,
        actions31, __args32, actions32, __args33, actions33, __args34, actions34, __args35, actions35, __args36,
        ...
        __args46, actions46, __args47, actions47, __args48, actions48, __args49, actions49, __args50, actions50, test1,
        yes1, no1, consequent1, y2, __args51, actions51, __args52, actions52, __args53, actions53, x0, _check,
...
addRewrite("Program", ((__args = ["body", checkTop]), (actions = [].slice.call(__args, 1)), seq(moveChild("body"),
    sequencea(actions), up)));
addRewrite("Package", seq(((__args0 = ["exports", checkTop]), (actions0 = [].slice.call(__args0, 1)), seq(moveChild(
    "exports"), sequencea(actions0), up)), ((__args1 = ["body", checkTop]), (actions1 = [].slice.call(__args1,
    1)), seq(moveChild("body"), sequencea(actions1), up))));
...
addRewrite("SwitchCase", seq(((__args4 = ["test", checkTop]), (actions4 = [].slice.call(__args4, 1)), seq(moveChild(
    "test"), sequencea(actions4), up)), ((__args5 = ["consequent", checkTop]), (actions5 = [].slice.call(
    __args5, 1)), seq(moveChild("consequent"), sequencea(actions5), up))));
addRewrite("CatchClause", seq(((__args6 = ["param", checkTop]), (actions6 = [].slice.call(__args6, 1)), seq(moveChild(
    "param"), sequencea(actions6), up)), ((__args7 = ["body", checkTop]), (actions7 = [].slice.call(__args7, 1)),
...
addRewrite("VariableDeclarator", ((test = inspect(((y0 = getUid), (function(z) {
    ...
    sequencea(actions9), up)), (no = removeBinding), test.chain((function(uid) {
...
addRewrite("Binding", ((__args10 = ["value", checkTop]), (actions10 = [].slice.call(__args10, 1)), (consequent = seq(
    ...
    "value"), sequencea(actions11), up)), (no0 = removeBinding), (alternate = test0.chain((function(uid) {
    return getState.chain((function(s) {
...
addRewrite("ExpressionStatement", ((__args13 = ["expression", checkTop]), (actions13 = [].slice.call(__args13, 1)), seq(
    moveChild("expression"), sequencea(actions13), up)));
addRewrite("WithStatement", seq(((__args14 = ["body", checkTop]), (actions14 = [].slice.call(__args14, 1)), seq(
    moveChild("body"), sequencea(actions14), up)), ((__args15 = ["bindings", checkTop]), (actions15 = [].slice.call(
    __args15, 1)), seq(moveChild("bindings"), sequencea(actions15), up))));
addRewrite("SwitchStatement", seq(((__args16 = ["discriminant", checkTop]), (actions16 = [].slice.call(__args16, 1)),
    seq(moveChild("discriminant"), sequencea(actions16), up)), ((__args17 = ["cases", checkTop]), (actions17 = []
    .slice.call(__args17, 1)), seq(moveChild("cases"), sequencea(actions17), up))));
addRewrite(["ReturnStatement", "ThrowStatement"], ((__args18 = ["argument", checkTop]), (actions18 = [].slice.call(
    __args18, 1)), seq(moveChild("argument"), sequencea(actions18), up)));
addRewrite("TryStatement", seq(((__args19 = ["block", checkTop]), (actions19 = [].slice.call(__args19, 1)), seq(
    moveChild("block"), sequencea(actions19), up)), ((__args20 = ["handler", checkTop]), (actions20 = [].slice.call(
    __args20, 1)), seq(moveChild("handler"), sequencea(actions20), up)), ((__args21 = ["finalizer", checkTop]), (
    actions21 = [].slice.call(__args21, 1)), seq(moveChild("finalizer"), sequencea(actions21), up))));
addRewrite(["WhileStatement", "DoWhileStatement"], seq(((__args22 = ["test", checkTop]), (actions22 = [].slice.call(
    __args22, 1)), seq(moveChild("test"), sequencea(actions22), up)), ((__args23 = ["body", checkTop]), (
    actions23 = [].slice.call(__args23, 1)), seq(moveChild("body"), sequencea(actions23), up))));
addRewrite("ForStatement", seq(((__args24 = ["body", checkTop]), (actions24 = [].slice.call(__args24, 1)), seq(
    moveChild("body"), sequencea(actions24), up)), ((__args25 = ["update", checkTop]), (actions25 = [].slice.call(
    __args25, 1)), seq(moveChild("update"), sequencea(actions25), up)), ((__args26 = ["test", checkTop]), (
    actions26 = [].slice.call(__args26, 1)), seq(moveChild("test"), sequencea(actions26), up)), ((__args27 = [
    "init", checkTop
]), (actions27 = [].slice.call(__args27, 1)), seq(moveChild("init"), sequencea(actions27), up))));
addRewrite(["ConditionalExpression", "IfStatement"], seq(((__args28 = ["test", checkTop]), (actions28 = [].slice.call(
    __args28, 1)), seq(moveChild("test"), sequencea(actions28), up)), ((__args29 = ["consequent", checkTop]), (
    actions29 = [].slice.call(__args29, 1)), seq(moveChild("consequent"), sequencea(actions29), up)), ((
    __args30 = ["alternate", checkTop]), (actions30 = [].slice.call(__args30, 1)), seq(moveChild(
    "alternate"), sequencea(actions30), up))));
addRewrite("FunctionExpression", seq(((__args31 = ["body", checkTop]), (actions31 = [].slice.call(__args31, 1)), seq(
    moveChild("body"), sequencea(actions31), up)), ((__args32 = ["id", checkTop]), (actions32 = [].slice.call(
    __args32, 1)), seq(moveChild("id"), sequencea(actions32), up)), ((__args33 = ["params", checkTop]), (
...
addRewrite("MemberExpression", seq(((__args39 = ["object", checkTop]), (actions39 = [].slice.call(__args39, 1)), seq(
    moveChild("object"), sequencea(actions39), up)), ((__args40 = ["property", checkTop]), (actions40 = [].slice
    .call(__args40, 1)), (consequent0 = seq(moveChild("property"), sequencea(actions40), up)), extract((
    function(node) {
        return (node.computed ? consequent0 : (undefined || pass));
    })))));
addRewrite("NewExpression", seq(((__args41 = ["callee", checkTop]), (actions41 = [].slice.call(__args41, 1)), seq(
    moveChild("callee"), sequencea(actions41), up)), ((__args42 = ["args", checkTop]), (actions42 = [].slice.call(
    __args42, 1)), seq(moveChild("args"), sequencea(actions42), up))));
addRewrite("CallExpression", seq(((__args43 = ["callee", checkTop]), (actions43 = [].slice.call(__args43, 1)), seq(
    moveChild("callee"), sequencea(actions43), up)), ((__args44 = ["args", checkTop]), (actions44 = [].slice.call(
    __args44, 1)), seq(moveChild("args"), sequencea(actions44), up))));
