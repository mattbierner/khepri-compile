...
var __o = require("khepri-ast")["node"],
    ...
    getUid = __o2["getUid"],
    Empty = __o3["Empty"],
    x, y, move, __args0, actions0, __args1, actions1, __args4, actions4, __args5, actions5, __args6, actions6, __args7,
        actions7, __args14, actions14, __args15, actions15, __args16, actions16, __args17, actions17, __args19,
        ...
        actions29, __args30, actions30, __args31, actions31, __args32, actions32, __args33, actions33, __args35,
        actions35, __args36, actions36, __args37, actions37, __args38, actions38, consequent0, __args39, actions39,
        __args40, actions40, __args41, actions41, __args42, actions42, __args44, actions44, __args45, actions45, _check,
...
var x1 = addRewrite.bind(null, "Package"),
    y1 = seq(((__args0 = ["exports", checkTop]), (actions0 = [__args0[1]]), seq(moveChild("exports"), sequencea(
        actions0), up)), ((__args1 = ["body", checkTop]), (actions1 = [__args1[1]]), seq(moveChild("body"),
...
var x4 = addRewrite.bind(null, "SwitchCase"),
    y4 = seq(((__args4 = ["test", checkTop]), (actions4 = [__args4[1]]), seq(moveChild("test"), sequencea(actions4), up)), (
        (__args5 = ["consequent", checkTop]), (actions5 = [__args5[1]]), seq(moveChild("consequent"), sequencea(
            actions5), up)));
x4(y4);
var x5 = addRewrite.bind(null, "CatchClause"),
    y5 = seq(((__args6 = ["param", checkTop]), (actions6 = [__args6[1]]), seq(moveChild("param"), sequencea(actions6),
        up)), ((__args7 = ["body", checkTop]), (actions7 = [__args7[1]]), seq(moveChild("body"), sequencea(actions7),
        up)));
x5(y5);
...
var x11 = addRewrite.bind(null, "WithStatement"),
    y11 = seq(((__args14 = ["body", checkTop]), (actions14 = [__args14[1]]), seq(moveChild("body"), sequencea(actions14),
        up)), ((__args15 = ["bindings", checkTop]), (actions15 = [__args15[1]]), seq(moveChild("bindings"),
        sequencea(actions15), up)));
x11(y11);
var x12 = addRewrite.bind(null, "SwitchStatement"),
    y12 = seq(((__args16 = ["discriminant", checkTop]), (actions16 = [__args16[1]]), seq(moveChild("discriminant"),
        sequencea(actions16), up)), ((__args17 = ["cases", checkTop]), (actions17 = [__args17[1]]), seq(moveChild(
        "cases"), sequencea(actions17), up)));
x12(y12);
...
var x14 = addRewrite.bind(null, "TryStatement"),
    y14 = seq(((__args19 = ["block", checkTop]), (actions19 = [__args19[1]]), seq(moveChild("block"), sequencea(
        actions19), up)), ((__args20 = ["handler", checkTop]), (actions20 = [__args20[1]]), seq(moveChild("handler"),
        sequencea(actions20), up)), ((__args21 = ["finalizer", checkTop]), (actions21 = [__args21[1]]), seq(
        moveChild("finalizer"), sequencea(actions21), up)));
x14(y14);
var x15 = addRewrite.bind(null, ["WhileStatement", "DoWhileStatement"]),
    y15 = seq(((__args22 = ["test", checkTop]), (actions22 = [__args22[1]]), seq(moveChild("test"), sequencea(actions22),
        up)), ((__args23 = ["body", checkTop]), (actions23 = [__args23[1]]), seq(moveChild("body"), sequencea(
        actions23), up)));
x15(y15);
var x16 = addRewrite.bind(null, "ForStatement"),
    y16 = seq(((__args24 = ["body", checkTop]), (actions24 = [__args24[1]]), seq(moveChild("body"), sequencea(actions24),
        up)), ((__args25 = ["update", checkTop]), (actions25 = [__args25[1]]), seq(moveChild("update"), sequencea(
        actions25), up)), ((__args26 = ["test", checkTop]), (actions26 = [__args26[1]]), seq(moveChild("test"),
        sequencea(actions26), up)), ((__args27 = ["init", checkTop]), (actions27 = [__args27[1]]), seq(moveChild(
        "init"), sequencea(actions27), up)));
x16(y16);
var x17 = addRewrite.bind(null, ["ConditionalExpression", "IfStatement"]),
    y17 = seq(((__args28 = ["test", checkTop]), (actions28 = [__args28[1]]), seq(moveChild("test"), sequencea(actions28),
        up)), ((__args29 = ["consequent", checkTop]), (actions29 = [__args29[1]]), seq(moveChild("consequent"),
        sequencea(actions29), up)), ((__args30 = ["alternate", checkTop]), (actions30 = [__args30[1]]), seq(
        moveChild("alternate"), sequencea(actions30), up)));
x17(y17);
var x18 = addRewrite.bind(null, "FunctionExpression"),
    y18 = seq(((__args31 = ["body", checkTop]), (actions31 = [__args31[1]]), seq(moveChild("body"), sequencea(actions31),
        up)), ((__args32 = ["id", checkTop]), (actions32 = [__args32[1]]), seq(moveChild("id"), sequencea(actions32),
        up)), ((__args33 = ["params", checkTop]), (actions33 = [__args33[1]]), seq(moveChild("params"), sequencea(
        actions33), up)));
x18(y18);
...
var x20 = addRewrite.bind(null, ["BinaryExpression", "AssignmentExpression"]),
    y20 = seq(((__args35 = ["left", checkTop]), (actions35 = [__args35[1]]), seq(moveChild("left"), sequencea(actions35),
        up)), ((__args36 = ["right", checkTop]), (actions36 = [__args36[1]]), seq(moveChild("right"), sequencea(
        actions36), up)));
x20(y20);
var x21 = addRewrite.bind(null, ["MemberExpression", "CheckedMemberExpression"]),
    y21 = seq(((__args37 = ["object", checkTop]), (actions37 = [__args37[1]]), seq(moveChild("object"), sequencea(
        actions37), up)), ((__args38 = ["property", checkTop]), (actions38 = [__args38[1]]), (consequent0 = seq(
        moveChild("property"), sequencea(actions38), up)), extract((function(node) {
        return (node.computed ? consequent0 : (undefined || pass));
    }))));
x21(y21);
var x22 = addRewrite.bind(null, ["CallExpression", "NewExpression", "ApplyExpression"]),
    y22 = seq(((__args39 = ["callee", checkTop]), (actions39 = [__args39[1]]), seq(moveChild("callee"), sequencea(
        actions39), up)), ((__args40 = ["args", checkTop]), (actions40 = [__args40[1]]), seq(moveChild("args"),
        sequencea(actions40), up)));
x22(y22);
var x23 = addRewrite.bind(null, "CurryExpression"),
    y23 = seq(((__args41 = ["base", checkTop]), (actions41 = [__args41[1]]), seq(moveChild("base"), sequencea(actions41),
        up)), ((__args42 = ["args", checkTop]), (actions42 = [__args42[1]]), seq(moveChild("args"), sequencea(
        actions42), up)));
x23(y23);
...
var x25 = addRewrite.bind(null, "LetExpression"),
    y25 = seq(((__args44 = ["body", checkTop]), (actions44 = [__args44[1]]), seq(moveChild("body"), sequencea(actions44),
        up)), ((__args45 = ["bindings", checkTop]), (actions45 = [__args45[1]]), seq(moveChild("bindings"),
        sequencea(actions45), up)));
x25(y25);
