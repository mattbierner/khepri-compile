...
addCheck("UnaryExpression", seq(((__args46 = ["argument", checkTop]), (actions46 = [].slice.call(__args46, 1)), seq(
    moveChild("argument"), seqa(actions46), up)), inspect((function(__o3) {
    var loc = __o3["loc"],
...
addCheck("AssignmentExpression", seq(((__args47 = ["left", checkTop]), (actions47 = [].slice.call(__args47, 1)), seq(
    moveChild("left"), seqa(actions47), up)), ((consequent2 = inspect((function(__o3) {
...
addCheck(["MemberExpression", "CheckedMemberExpression"], seq(((__args57 = ["object", checkTop]), (actions57 = [].slice
    .call(__args57, 1)), seq(moveChild("object"), seqa(actions57), up)), ((__args58 = ["property", checkTop]), (
        actions58 = [].slice.call(__args58, 1)), (consequent3 = seq(moveChild("property"), seqa(actions58), up)),
    inspect((function(node) {
