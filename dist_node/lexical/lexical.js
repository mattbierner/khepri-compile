...
var __o = require("khepri-ast")["node"],
    ...
    scope = require("./scope"),
    Scope = scope["Scope"],
    check, x, y, x0, y0, x1, y1, x2, y2, body, __args, actions, __args0, actions0, __args1, actions1, body0, __args2,
        actions2, __args3, actions7, x3, consequent, __args7, actions6, alternate, __args4, actions3, __args5, actions5,
...
addCheck("Package", ((body0 = [((__args2 = ["exports", checkTop]), (actions2 = [].slice.call(__args2, 1)), seq(
    moveChild("exports"), seqa(actions2), up)), ((__args3 = ["body", ((x3 = type), (consequent = seq(((
