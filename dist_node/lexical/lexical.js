...
})), (consequent0 = seq(inspect(bind), child("id", checkTop), child("init", checkTop))), (alternate0 = seq(
    child("init", checkTop), inspect(bind), child("id", checkTop))), inspect((function(node) {
    return (node.recursive ? consequent0 : (alternate0 || pass));
}))));
addCheck("Binding", ((consequent1 = seq(child("pattern", checkTop), child("value", checkTop))), (alternate1 = seq(child(
